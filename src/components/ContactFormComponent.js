...
const ContactForm = () => {
    ...
    return (
        <Box sx={{textAlign: 'justify', bgcolor: 'background.paper', alignItems: 'center', alignSelf: 'center',color: 'black', backgroundColor: 'white', padding: '20px', margin: '10px auto 10px auto', width: '60vw' }}
                    component="form" 
                    autoComplete="off"
